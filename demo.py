...
def demo_web_frameworks() -> None:
    ...
    print("        if hit:")
    print("            return {'answer': hit.value, 'source': 'cache'}")
    print("")
    print("        # 2. If missed, get from AI/DB and save for future users!")
    print("        answer = call_my_ai_or_db(question)")
    print("        cache.set(question, answer)")
    print("        return {'answer': answer, 'source': 'ai_or_db'}")
    ...
    print("        hit = cache.get(question)")
    print("        if hit:")
    print("            return JsonResponse({'answer': hit.value, 'source': 'cache'})")
    print("")
    print("        answer = call_my_ai_or_db(question)")
    print("        cache.set(question, answer)")
    print("        return JsonResponse({'answer': answer, 'source': 'ai_or_db'})")
